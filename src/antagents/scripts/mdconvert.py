...
import markdownify
import pandas as pd
import pdfminer # 注意需要导入 pip install pdfminer.six
import pdfminer.high_level
import pptx # 注意需要导入 pip install python-pptx

# File-format detection
import puremagic
import pydub
import requests
import speech_recognition as sr # 注意需要导入 pip install speechrecognition
